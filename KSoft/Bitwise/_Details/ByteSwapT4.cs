...
namespace KSoft.Bitwise
{
	partial class ByteSwap
	{
		...
		{
			return
				(ushort)( ((value >>  8) & 0x00FF) | ((value <<  8) & 0xFF00) );
		}
		...
		public static void Swap(
			ref ushort value)
		{
			value = (ushort)( ((value >>  8) & 0x00FF) | ((value <<  8) & 0xFF00) );
		}
		...
		public static void SwapUInt16(byte[] buffer, int offset)
		{
			...
			byte b0, b1;
			b0 = buffer[offset++]; b1 = buffer[offset++]; 

			buffer[--offset] = b0; buffer[--offset] = b1; 
		}
			...
			ushort value)
		{
			...
			if(BitConverter.IsLittleEndian) {
				b0 = (byte)(value >>  8); b1 = (byte)(value >>  0); 
			} else {
				b0 = (byte)(value >>  0); b1 = (byte)(value >>  8); 
			}
		...
		public static void Swap(
			ref short value)
		{
			value = (short)( ((value >>  8) & 0x00FF) | (value <<  8) );
		}
		...
		{
			return
				((value >> 24) & 0x000000FF) | ((value >>  8) & 0x0000FF00) | ((value <<  8) & 0x00FF0000) | ((value << 24) & 0xFF000000);
		}
		...
		public static void SwapUInt32(byte[] buffer, int offset)
		{
			...
			byte b0, b1, b2, b3;
			b0 = buffer[offset++]; b1 = buffer[offset++]; b2 = buffer[offset++]; b3 = buffer[offset++]; 

			buffer[--offset] = b0; buffer[--offset] = b1; buffer[--offset] = b2; buffer[--offset] = b3; 
		}
			...
			uint value)
		{
			...
			byte b0, b1, b2, b3;
			if(BitConverter.IsLittleEndian) {
				b0 = (byte)(value >> 24); b1 = (byte)(value >> 16); b2 = (byte)(value >>  8); b3 = (byte)(value >>  0); 
			} else {
				b0 = (byte)(value >>  0); b1 = (byte)(value >>  8); b2 = (byte)(value >> 16); b3 = (byte)(value >> 24); 
			}
		...
		{
			return (int)
				((value >> 24) & 0x000000FF) | ((value >>  8) & 0x0000FF00) | ((value <<  8) & 0x00FF0000) | (value << 24);
		}
		...
		public static void Swap(
			ref int value)
		{
			value = ((value >> 24) & 0x000000FF) | ((value >>  8) & 0x0000FF00) | ((value <<  8) & 0x00FF0000) | (value << 24);
		}
		...
		{
			return
				((value >> 56) & 0x00000000000000FF) | ((value >> 40) & 0x000000000000FF00) | ((value >> 24) & 0x0000000000FF0000) | ((value >>  8) & 0x00000000FF000000) | ((value <<  8) & 0x000000FF00000000) | ((value << 24) & 0x0000FF0000000000) | ((value << 40) & 0x00FF000000000000) | ((value << 56) & 0xFF00000000000000);
		}
		...
		public static void Swap(
			ref ulong value)
		{
			value = ((value >> 56) & 0x00000000000000FF) | ((value >> 40) & 0x000000000000FF00) | ((value >> 24) & 0x0000000000FF0000) | ((value >>  8) & 0x00000000FF000000) | ((value <<  8) & 0x000000FF00000000) | ((value << 24) & 0x0000FF0000000000) | ((value << 40) & 0x00FF000000000000) | ((value << 56) & 0xFF00000000000000);
		}
		...
		public static void SwapUInt64(byte[] buffer, int offset)
		{
			...
			b0 = buffer[offset++]; b1 = buffer[offset++]; b2 = buffer[offset++]; b3 = buffer[offset++]; b4 = buffer[offset++]; b5 = buffer[offset++]; b6 = buffer[offset++]; b7 = buffer[offset++]; 

			buffer[--offset] = b0; buffer[--offset] = b1; buffer[--offset] = b2; buffer[--offset] = b3; buffer[--offset] = b4; buffer[--offset] = b5; buffer[--offset] = b6; buffer[--offset] = b7; 
		}
			...
			ulong value)
		{
			...
			byte b0, b1, b2, b3, b4, b5, b6, b7;
			if(BitConverter.IsLittleEndian) {
				b0 = (byte)(value >> 56); b1 = (byte)(value >> 48); b2 = (byte)(value >> 40); b3 = (byte)(value >> 32); b4 = (byte)(value >> 24); b5 = (byte)(value >> 16); b6 = (byte)(value >>  8); b7 = (byte)(value >>  0); 
			} else {
				b0 = (byte)(value >>  0); b1 = (byte)(value >>  8); b2 = (byte)(value >> 16); b3 = (byte)(value >> 24); b4 = (byte)(value >> 32); b5 = (byte)(value >> 40); b6 = (byte)(value >> 48); b7 = (byte)(value >> 56); 
			}
		...
		{
			return (long)
				((value >> 56) & 0x00000000000000FF) | ((value >> 40) & 0x000000000000FF00) | ((value >> 24) & 0x0000000000FF0000) | ((value >>  8) & 0x00000000FF000000) | ((value <<  8) & 0x000000FF00000000) | ((value << 24) & 0x0000FF0000000000) | ((value << 40) & 0x00FF000000000000) | (value << 56);
		}
		...
		public static void Swap(
			ref long value)
		{
			value = ((value >> 56) & 0x00000000000000FF) | ((value >> 40) & 0x000000000000FF00) | ((value >> 24) & 0x0000000000FF0000) | ((value >>  8) & 0x00000000FF000000) | ((value <<  8) & 0x000000FF00000000) | ((value << 24) & 0x0000FF0000000000) | ((value << 40) & 0x00FF000000000000) | (value << 56);
		}
