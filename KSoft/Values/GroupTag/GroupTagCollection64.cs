...
namespace KSoft.Values
{
	...
	public sealed class GroupTag64Collection : GroupTagCollection
	{
		...
		public GroupTag64Collection(params GroupTagDatum[] groupTags) : this(KGuid.Empty, Util.ThrowIfNull(groupTags))
		{
		}
		/// <summary>Create a collection based on an existing list of group tags</summary>
		/// <param name="uuid">Guid for this group tag collection</param>
		/// <param name="groupTags">Group tags to populate this collection with</param>
		public GroupTag64Collection(KGuid uuid, params GroupTagDatum[] groupTags) : base(Util.ThrowIfNull(groupTags), uuid)
		{
		...
		/// <param name="groupTags">Group tags to populate this collection with</param>
		public GroupTag64Collection(bool sort, params GroupTagDatum[] groupTags) : this(Util.ThrowIfNull(groupTags))
		{
			if (sort)
			{
				Sort();
		...
		/// <param name="sort">Should we sort the list?</param>
		/// <param name="groupTags">Group tags to populate this collection with</param>
		public GroupTag64Collection(KGuid uuid, bool sort, params GroupTagDatum[] groupTags)
