...
namespace KSoft.Security.Cryptography
{
	...
	public class TigerHash : BlockHashAlgorithm
	{
		...
		static TigerHash()
		{
			System.Security.Cryptography.CryptoConfig.AddAlgorithm(typeof(TigerHash), kAlgorithmName);
		}
		#endregion
		...
		public TigerHash() : base(kBlockSize, kHashSize)
		{
			Initialize();
		}
		...
		protected override void ProcessBlock(byte[] inputBuffer, int inputOffset, int blockCount)
		{
			...
			if (mX.Length < space_needed) Array.Resize(ref mX, space_needed);
		...
		protected override byte[] ProcessFinalBlock(byte[] inputBuffer, int inputOffset, int inputCount)
		{
			...
			Bits.ArrayCopy(mRegs, 0, HashValue, 0, 3); return HashValue;
		}
		...
		static void KeySchedule(ref ulong x0, ref ulong x1, ref ulong x2, ref ulong x3,
