...
internal static class DiagnosticDescriptors
{
	...
	public static readonly DiagnosticDescriptor InvalidPropertyChangedHost = Create("KSPC0004", "Invalid property-change host", "Type '{0}' must use a valid GeneratedPropertyChangedHost marker, directly derive from KSoft.ObjectModel.BasicViewModel, or inherit a supported property-change framework host");
