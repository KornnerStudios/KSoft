...
public sealed partial class PropertyChangedGeneratorTests
{
	...
	public void CacheOnlyContractRejectsExplicitInterfacePropertyTest()
	{
		...
		StringAssert.Contains(
			source,
			"new(nameof(global::IValue.Value));",
			StringComparison.Ordinal);
		AssertValid(run);
	}

	[TestMethod]
	public void CacheOnlyContractPreservesOrdinaryPropertyOutputTest()
	{
		TestRun run = Run("""
			using KSoft.PropertyChanged.SourceGeneration;

			public partial class OrdinaryCacheProperty
			{
				[GeneratedPropertyChangedEventArgs]
				public int Value { get; set; }
			}
		...
		AssertSourceEquivalent(
			...
			public partial class OrdinaryCacheProperty
			{
				static readonly global::System.ComponentModel.PropertyChangedEventArgs kValueChangedEventArgs =
					new(nameof(Value));
			}
			""",
			PropertySource(run));
	...
	[TestMethod]
	public void CacheOnlyContractRejectsOrdinaryAndExplicitDuplicateFieldNamesTest()
	{
		TestRun run = Run("""
			using KSoft.PropertyChanged.SourceGeneration;
			...
			public partial class DuplicateCacheProperty : IValue
			{
				[GeneratedPropertyChangedEventArgs]
				public int Value { get; set; }
		...
		AssertDiagnosticIds(run, "KSPC0006", "KSPC0006");
