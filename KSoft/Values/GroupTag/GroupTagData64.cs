...
namespace KSoft.Values
{
	...
	public sealed class GroupTagData64 : GroupTagData
	{
		...
		public static TagWord ToULong(ReadOnlySpan<char> tag)
		{
		...
		/// <remarks>Writes a big-endian ordered eight-cc if <paramref name="isBigEndian"/> is true, little-endian if false</remarks>
		public static void FromULong(TagWord groupTag, Span<char> tag, bool isBigEndian = true)
		{
			ArgumentOutOfRangeException.ThrowIfLessThan(tag.Length, kExpectedTagLength, nameof(tag));
	...
	public sealed class GroupTagData64Attribute : GroupTagDataAttribute
	{
		...
		{
			Verify.GroupTags.NameAndExactLength(groupTag, name, GroupTagData64.kExpectedTagLength);
